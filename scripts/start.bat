...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0start-background.ps1" -ProxyPath "%~dp0proxy.js" -WorkingDirectory "%CD%" -LogPath "%~dp0..\logs\proxy.log" -ErrLogPath "%~dp0..\logs\proxy.err.log"
